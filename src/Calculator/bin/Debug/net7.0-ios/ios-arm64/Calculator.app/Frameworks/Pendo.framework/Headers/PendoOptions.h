...
/** @brief version that is used by hosting app. */
...
/** @brief flutter integration type, ie: Observable/TrakEvents. */
...
// TODO: Max - senior review, API change
/** @brief controls the depth of the reflection tree, for swiftUI only */
