...
@interface PendoOptions : NSObject {
}
	-(void) setIsMAUI:(BOOL)p0;
	-(void) setPlatformVersion:(NSString *)p0;
	-(id) init;
@end

@interface PendoMaui_PendoOptions : PendoOptions {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface PendoManager : NSObject {
	...
	-(NSString *) visitorId;
	-(void) initWithUrl:(NSURL *)p0;
	-(void) pauseGuides:(BOOL)p0;
	-(void) resumeGuides;
	-(void) screenContentChanged;
	-(void) setAccountData:(NSDictionary *)p0;
	-(void) setDebugMode:(BOOL)p0;
	-(void) setVisitorData:(NSDictionary *)p0;
	-(void) setup:(NSString *)p0;
	-(void) setup:(NSString *)p0 withOptions:(id)p1;
	-(void) startSession:(NSString *)p0 accountId:(NSString *)p1 visitorData:(NSDictionary *)p2 accountData:(NSDictionary *)p3;
